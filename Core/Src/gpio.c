...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOA, GPIO_PIN_0|GPIO_PIN_4|LD4_Pin|GPIO_PIN_9
  ...
  /*Configure GPIO pins : PA0 PA4 PAPin PA9
                           PA10 PA11 PA12 */
  GPIO_InitStruct.Pin = GPIO_PIN_0|GPIO_PIN_4|LD4_Pin|GPIO_PIN_9
